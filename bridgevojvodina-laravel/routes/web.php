...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('tournaments/{tournament}/rounds/{roundId}/matches/{matchId}/boards-count', [TournamentController::class, 'updateMatchBoardsCount'])->name('tournaments.rounds.matches.boards-count.update');
    Route::patch('tournaments/{tournament}/rounds/{roundId}/matches/{matchId}/manual-result', [TournamentController::class, 'updateMatchManualResult'])->name('tournaments.rounds.matches.manual-result.update');
