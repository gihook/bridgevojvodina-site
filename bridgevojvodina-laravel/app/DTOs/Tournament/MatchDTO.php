...
class MatchDTO
{
    ...
    public function __construct(
        ...
        public bool $vp_override = false,
        public int $home_carryover_imp = 0,
        public int $away_carryover_imp = 0,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            vp_override: (bool) ($data['vp_override'] ?? false),
            home_carryover_imp: (int) ($data['home_carryover_imp'] ?? 0),
            away_carryover_imp: (int) ($data['away_carryover_imp'] ?? 0),
    ...
    public function toArray(): array
    {
        return [
            ...
            'vp_override' => $this->vp_override,
            'home_carryover_imp' => $this->home_carryover_imp,
            'away_carryover_imp' => $this->away_carryover_imp,
